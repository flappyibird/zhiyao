...
class Buypost(models.Model):
    ...
    releasebtime = models.DateTimeField(db_column='releaseBTime')  # Field name made lowercase.
...
class Plantstatistics(models.Model):
    ...
    plantstage = models.CharField(db_column='plantStage', max_length=20)  # Field name made lowercase.
    plant_plantname = models.ForeignKey(Plant, models.DO_NOTHING, db_column='Plant_plantName', blank=True, null=True)  # Field name made lowercase.
...
class User(models.Model):
    ...
    userstate = models.IntegerField(db_column='userState')  # Field name made lowercase.
